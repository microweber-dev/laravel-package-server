        ...
        <div class="col-md-12">
            <div class="card shadow bg-light">
                <div class="card-body bg-white px-5 py-3 border-bottom rounded-top">
                    <div class="mx-3 my-3">
                        <h3 class="h3 my-4">
                            Welcome to Microweber Packages!
                        </h3>

                        <div class="text-muted">
                            Use microweber packages if you want to share private code as a Composer package with colleagues
                            or customers without publishing it for everyone on http://market.microweberapi.com.  <br />
                            Private packages allows you to manage your own private Composer repository with per-user authentication,
                            team management and integration in version control systems.
                        </div>
                    </div>
                </div>
                <div class="row g-0">
